export default {
    ...
    introductiondetail: 'I\'m a calm and responsible person, willing to explore more interesting things. Facing with a task alone, even it is hard, I can learn the related knowledge, master it quickly, and finish it as soon as I can. Besides, when I was in a group as a leader, I can organise the project in an order and create a comfortable atmosphere, which helps me build the confidence in my future work. In summary, with these experience both in coding, ways of thinking and leadership, I am able to work more efficient under the pressure and challenges.',
    skilltitle: 'My Skills',
    skillintruduction: 'As a senior front-end developer in the company, I can skillfully use various frontend skills like React, JQuery, HTML, CSS, JavaScript, WebPack for development and packaging.',
